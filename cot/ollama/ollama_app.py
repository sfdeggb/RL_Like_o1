    ...
    for attempt in range(3):
        try:
            response = ollama.chat(
                model="krith/gemma-2-2b-it-abliterated:IQ3_M",
                messages=messages,
...
def main():
    ...
    st.title("g1: Using gemma-2-2b-it on ollama to create o1-like reasoning chains")
    
    st.markdown("""
    This is an early prototype of using prompting to create o1-like reasoning chains to improve output accuracy. \
    It is not perfect and accuracy has yet to be formally evaluated. It is powered by Ollama.
                
    Open source [repository here](https://github.com/ollama/ollama)
    """)
