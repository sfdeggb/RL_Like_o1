# g1: Using gemma-2-2b-it on Groq to create o1-like reasoning chains

English | [简体中文](./Readme_zh.md) </br>
...
g1 powered by gemma-2-2b-it creates reasoning chains, in principle a dynamic Chain of Thought, that allows the LLM to "think" and solve some logical problems that usually otherwise stump leading models.
